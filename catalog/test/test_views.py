...
class AuthorCreateTest(TestCase):
    ...
    def test_redirect_if_user_does_not_have_permission(self):
    ...
    def test_author_form_invalid_fields(self):
        login = self.client.login(username='testuser2', password='12345')
        resp = self.client.post(reverse('author_create'), {'date_of_birth':'a'})
        self.assertEqual( resp.status_code,200)
